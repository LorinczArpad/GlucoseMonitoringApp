...
- Create Angular project with ng: `ng new glucosemonitoringapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`glucosemonitoringapp.client.esproj`).
